...
struct hash {
    ...
    { "SHA224", SHA224, SHA224HashSize, {
        ...
        }, SHA224_SEED, { "100966A5B4FDE0B42E2A6C5953D4D7F41BA7CF79FD2DF431416734BE",
                          "1DCA396B0C417715DEFAAE9641E10A2E99D55ABCB8A00061EB3BE8BD",
                          "1864E627BDB2319973CD5ED7D68DA71D8BF0F983D8D9AB32C34ADB34",
                          "A2406481FC1BCAF24DD08E6752E844709563FB916227FED598EB621F"
        }
    },
    { "SHA256", SHA256, SHA256HashSize, {
        ...
        /* 7 */ { TEST7_256, length(TEST7_256), 1, 0x60, 3,
                  "77EC1DC89C821FF2A1279089FA091B35B8CD960BCAF7DE01C6A7680756BEB972" },
        /* 8 */ { TEST8_256, length(TEST8_256), 1, 0, 0,
                  "175EE69B02BA9B58E2B0A5FD13819CEA573F3940A94F825128CF4209BEABB4E8" },
        /* 9 */ { TEST9_256, length(TEST9_256), 1, 0xA0, 3,
                  "3E9AD6468BBBAD2AC3C2CDC292E018BA5FD70B960CF1679777FCE708FDB066E9" },
        /* 10 */ { TEST10_256, length(TEST10_256), 1, 0, 0,
                   "97DBCA7DF46D62C8A422C941DD7E835B8AD3361763F7E9B2D95F4F0DA6E1CCBC" },
        }, SHA256_SEED, { "83D28614D49C3ADC1D6FC05DB5F48037C056F8D2A4CE44EC6457DEA5DD797CD1",
                          "99DBE3127EF2E93DD9322D6A07909EB33B63995E529B3F954B8581621BB74D39",
                          "8D4BE295BB64661CA3C7EFD129A2F725B33072DBDDE32385B9A87B9AF88EA76F",
                          "40AF5D3F9716B040DF9408E31536B70FF906EC51B00447CA97D7DD97C12411F4"
        }
    },
    { "SHA384", SHA384, SHA384HashSize, {
        ...
        /* 10 */ { TEST10_384, length(TEST10_384), 1, 0, 0,
            ...
            "CE44D7D63AE0C91482998CF662A51EC80BF6FC68661A3C57"
            "F87566112BD635A743EA904DEB7D7A42AC808CABE697F38F",
            "F9C6D261881FEE41ACD39E67AA8D0BAD507C7363EB67E2B8"
            "1F45759F9C0FD7B503DF1A0B9E80BDE7BC333D75B804197D",
            "D96512D8C9F4A7A4967A366C01C6FD97384225B58343A882"
            "64847C18E4EF8AB7AEE4765FFBC3E30BD485D3638A01418F",
            "0CA76BD0813AF1509E170907A96005938BC985628290B25F"
            "EF73CF6FAD68DDBA0AC8920C94E0541607B0915A7B4457F7"
        }
    },
    {"SHA512", SHA512, SHA512HashSize, {
        ...
        /* 5 */ { "", 0, 0, 0xB0, 5,
                  "D4EE29A9E90985446B913CF1D1376C836F4BE2C1CF3CADA0720A6BF4857D886A"
                  "7ECB3C4E4C0FA8C7F95214E41DC1B0D21B22A84CC03BF8CE4845F34DD5BDBAD4" },
        /* 6 */ { "\xD0", 1, 1, 0, 0,
        ...
        /* 7 */ { TEST7_512, length(TEST7_512), 1, 0x80, 3,
                  "ED8DC78E8B01B69750053DBB7A0A9EDA0FB9E9D292B1ED715E80A7FE290A4E16"
                  "664FD913E85854400C5AF05E6DAD316B7359B43E64F8BEC3C1F237119986BBB6" },
        ...
        /* 9 */ { TEST9_512, length(TEST9_512), 1, 0x80, 3,
                  "32BA76FC30EAA0208AEB50FFB5AF1864FDBF17902A4DC0A682C61FCEA6D92B78"
                  "3267B21080301837F59DE79C6B337DB2526F8A0A510E5E53CAFED4355FE7C2F1" },
        /* 10 */ { TEST10_512, length(TEST10_512), 1, 0, 0,
            ...
            "2FBB1E7E00F746BA514FBC8C421F36792EC0E11FF5EFC378E1AB0C079AA5F0F6"
            "6A1E3EDBAEB4F9984BE14437123038A452004A55768C1FD8EED49E4A21BEDCD0",
            "25CBE5A4F2C7B1D7EF07011705D50C62C5000594243EAFD1241FC9F3D22B5818"
            "4AE2FEE38E171CF8129E29459C9BC2EF461AF5708887315F15419D8D17FE7949",
            "5B8B1F2687555CE2D7182B92E5C3F6C36547DA1C13DBB9EA4F73EA4CBBAF8941"
            "1527906D35B1B06C1B6A8007D05EC66DF0A406066829EAB618BDE3976515AAFC",
            "46E36B007D19876CDB0B29AD074FE3C08CDD174D42169D6ABE5A1414B6E79707"
            "DF58776A98091CF431854147BB6D3C66D43BFBC108FD715BDE6AA127C2B0E79F"
        }
    }
};
